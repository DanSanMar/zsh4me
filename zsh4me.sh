...
# MEJORA: inherit_errexit asegura que set -e también aplique dentro de subshells $()
set -eo pipefail
...
# MEJORA: Respaldo previo antes de sobrescribir
...
# MEJORA: Garantizar que la carpeta bin del usuario exista
mkdir -p "$REAL_HOME/.local/bin" "$REAL_HOME/bin"

cat << 'EOF' > "$ZSHRC_FILE"
# ==============================================================================
# 0. VARIABLES DE ENTORNO Y PATH (Recomendado por la comunidad)
# ==============================================================================
# Incluye directorios locales de binarios del usuario (~/.local/bin para scripts y herramientas)
...
# MEJORA: Cacheado rápido para compinit para acelerar el inicio de la shell
...
# ==============================================================================
# 3. HISTORIAL DE ZSH (Optimizaciones avanzadas)
# ==============================================================================
...
chown -R "$REAL_USER:$REAL_USER" "$GHOSTTY_CONF_DIR" "$TMUX_CONF_FILE" "$ZSHRC_FILE" "$REAL_HOME/.local/bin"
