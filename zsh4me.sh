...
# 1. Instalación de paquetes (Añadido 'micro')
...
# Crear .zshrc base solo si no existe
...
# Inyección segura del PATH y EDITOR (Anexa al final sin sobrescribir lo que ya existe)
